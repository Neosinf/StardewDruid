        ...
        public Dictionary<int, ContentComponent> JournalEffects()
        {
            ...
            foreach (string id in pageList)
            {
                ...
                for (int i = 0; i < effects[id].Count; i++)
                {
                    ...
                    ContentComponent content = new(ContentComponent.contentTypes.list, id + "." + i.ToString());
        ...
        public void Localise(string questId)
        {
            switch (questId)
            {
                ...
                case approachEffigy:
                    ...
                    LocationHandle.DruidLocations(LocationHandle.druid_gate_name);
            ...
            switch (questId)
            {
                ...
                case relicTactical:
                    ...
                    if (!Mod.instance.eventRegister.ContainsKey(questId))
                    {
                        ...
                        new Relics.RelicTactical().EventSetup(questId);
                ...
                case relicWeald:
                    ...
                    if (!Mod.instance.eventRegister.ContainsKey(questId))
                    {
                        ...
                        new Relics.RelicWeald().EventSetup(questId);
                ...
                case relicMists:
                    ...
                    if (!Mod.instance.eventRegister.ContainsKey(questId))
                    {
                        ...
                        new Relics.RelicMists().EventSetup(questId);
                ...
                case relicFates:
                    ...
                    if (!Mod.instance.eventRegister.ContainsKey(questId))
                    {
                        ...
                        new Relics.RelicFates().EventSetup(questId);
                ...
                case relicEther:
                    ...
                    if (!Mod.instance.eventRegister.ContainsKey(questId))
                    {
                        ...
                        new Relics.RelicEther().EventSetup(questId);
                ...
                case relicRestore:
                    ...
                    if (!Mod.instance.eventRegister.ContainsKey(questId))
                    {
                        ...
                        new Relics.RelicRestore().EventSetup(questId);
            ...
            switch (questId)
            {
                ...
                case swordHeirs:
                    ...
                    foreach (CharacterHandle.characters recruit in recruits)
                    {
                        ...
                        CharacterHandle.RecruitLoad(recruit,true);
            ...
            switch (questId)
            {
                ...
                case mistsTwo:
                    ...
                    foreach (HerbalData.herbals sat in satius)
                    {
                        ...
                        HerbalData.UpdateHerbalism(sat, 3);
                ...
                case starsOne:
                    ...
                    foreach (HerbalData.herbals mag in magnus)
                    {
                        ...
                        HerbalData.UpdateHerbalism(mag, 3);
                ...
                case fatesFour:
                    ...
                    HerbalData.UpdateHerbalism(HerbalData.herbals.faeth, 5);
                ...
                case etherFour:
                    ...
                    foreach (HerbalData.herbals opt in optimus)
                    {
                        ...
                        HerbalData.UpdateHerbalism(opt, 3);
            ...
            switch (questId)
            {
                ...
                case herbalism:
                    ...
                    foreach (HerbalData.herbals mel in melius)
                    {
                        ...
                        HerbalData.UpdateHerbalism(mel, 3);
                ...
                case challengeDragon:
                    ...
                    if (Game1.player.currentLocation is Lair vault)
                    {
                        ...
                        vault.AddCrateField(new(24, 10), SpawnData.swords.lava);

                        vault.AddCrateField(new(28, 10), new StardewValley.Object("336", 5));

                        vault.AddCrateField(new(32, 10), new StardewValley.Object("74", 1));
        ...
        public void OnReplayComplete(string questId, int questRating)
        {
            ...
            switch (questId)
            {
                ...
                case swordEther:
                    ...
                    HerbalData.UpdateHerbalism(HerbalData.herbals.faeth, 20);
