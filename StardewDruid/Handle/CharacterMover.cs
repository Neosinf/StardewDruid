...
namespace StardewDruid.Handle
{
    ...
    public class CharacterMover
    {
        ...
        public CharacterMover(Character.Character Entity, string Localisation, Vector2 Position, bool Animate, moveType Type = moveType.move)
        {
        ...
        public CharacterMover(Character.Character Entity, GameLocation Location, Vector2 Position, bool Animate, moveType Type = moveType.move)
        {
        ...
        public CharacterMover(Character.Character Entity, moveType Type = moveType.limbo)
        {
        ...
        public Character.Character ReferenceCharacter()
        {
        ...
        public void TryWipe()
        {
            ...
            for (int c = location.characters.Count-1; c >= 0; c--)
            {
                ...
                if (npc is Character.Character entity)
                {
        ...
        public void TryLimbo()
        {
            ...
            if(character.modeActive != Character.Character.mode.limbo)
            {
