...
{
    public class FriendGhost : StardewDruid.Character.Character
    {
        ...
        public FriendGhost(CharacterHandle.characters type = CharacterHandle.characters.PalGhost, int scheme = 0, int level = 1)
            ...
            else if (netSpecial.Value != 0)
            {
                ...
                switch (special)
                {
                    ...
                    case specials.tackle:
                        hoverAdditional.series = HoverRenderAdditional.hoverseries.tackle;
                        break;
