...
{
    public class Shapeshifter : StardewDruid.Character.Recruit
    {
        ...
        public Shapeshifter(CharacterHandle.characters type, NPC villager)
          : base(type, villager)
        {
        ...
        public override void LoadOut()
        {
            ...
            if (characterType == CharacterHandle.characters.none)
            {
                ...
                characterType = CharacterHandle.characters.Shapeshifter;
