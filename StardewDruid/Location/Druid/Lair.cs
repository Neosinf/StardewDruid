...
namespace StardewDruid.Location.Druid
{
    public class Lair : DruidLocation
    {
        ...
        public Dictionary<Vector2, Location.CrateField> crateFields = new();
        ...
        public override void draw(SpriteBatch b)
        {
            ...
            foreach (KeyValuePair<Vector2, Location.CrateField> crate in crateFields)
            {
        ...
        public override void OnMapLoad(xTile.Map map)
        {
            ...
            TileSheet dungeon = new(LocationHandle.druid_lair_name + "_dungeon", newMap, "Maps\\Mines\\volcano_dungeon", new(16, 36), tileSize);
            ...
            codes = new()
            {
                ...
                [22] = new() { new() { 0, 76 }, new() { 1, 76 }, new() { 2, 76 }, new() { 3, 76 }, new() { 4, 76 }, new() { 5, 76 }, new() { 6, 76 }, new() { 7, 76 }, new() { 8, 76 }, new() { 9, 76 }, new() { 10, 123 }, new() { 11, 273 }, new() { 12, 274 }, new() { 13, 274 }, new() { 14, 292 }, new() { 15, 259 }, new() { 36, 49 }, new() { 37, 195 }, new() { 38, 196 }, new() { 39, 180 }, new() { 40, 196 }, new() { 41, 197 }, new() { 42, 200 }, new() { 46, 112 }, new() { 47, 76 }, new() { 48, 76 }, new() { 49, 76 }, new() { 50, 76 }, new() { 51, 76 }, new() { 52, 76 }, new() { 53, 76 }, new() { 54, 76 }, new() { 55, 76 }, },
        ...
        public override bool isActionableTile(int xTile, int yTile, Farmer who)
        {
            ...
            if (crateFields.ContainsKey(actionTile))
            {

                if (crateFields[actionTile].status == CrateField.crateStatus.closed)
                {
        ...
        public void AddCrateField(Vector2 tile, StardewValley.Object obj)
        {
            ...
            map.Layers[1].Tiles[(int)tile.X, (int)tile.Y] = new StaticTile(map.Layers[1], map.Layers[0].Tiles[(int)tile.X, (int)tile.Y].TileSheet, BlendMode.Alpha, map.Layers[0].Tiles[(int)tile.X, (int)tile.Y].TileIndex);
