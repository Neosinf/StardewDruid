    ...
    public class Clearing : DruidLocation
    {
        ...
        public override void OnMapLoad(xTile.Map map)
        {
            ...
            codes = new()
            {
                ...
                [4] = new() { new() { 49, 2 }, new() { 50, 7 }, },
                [5] = new() { new() { 6, 2 }, new() { 12, 11 }, },
                [6] = new() { new() { 54, 2 }, },
                [7] = new() { new() { 2, 4 }, new() { 22, 12 }, new() { 40, 11 }, new() { 54, 3 }, },
                [8] = new() { new() { 35, 11 }, new() { 51, 8 }, },
                [9] = new() { new() { 14, 12 }, },
                [10] = new() { new() { 8, 11 }, },
                ...
                [14] = new() { new() { 10, 12 }, },
                [15] = new() { new() { 2, 7 }, },
                [16] = new() { new() { 2, 2 }, new() { 9, 11 }, new() { 53, 2 }, },
                [17] = new() { new() { 45, 12 }, new() { 52, 3 }, },
                [18] = new() { },
                [19] = new() { new() { 3, 8 }, },
                [20] = new() { new() { 0, 7 }, new() { 11, 12 }, new() { 54, 3 }, },
                [21] = new() { new() { 21, 11 }, new() { 37, 11 }, new() { 53, 4 }, },
                [22] = new() { new() { 30, 11 }, },
                [23] = new() { },
