    ...
    public class Gate : DruidLocation
    {
        ...
        public override void OnMapLoad(xTile.Map map)
        {
            ...
            Dictionary<int, List<List<int>>> groundCodes = new()
            {
                ...
                [8] = new() { new() { 12, 380 }, new() { 13, 380 }, new() { 14, 380 }, new() { 15, 380 }, new() { 16, 380 }, new() { 17, 380 }, new() { 18, 380 }, new() { 19, 380 }, new() { 20, 380 }, new() { 21, 381 }, new() { 22, 351 }, new() { 23, 351 }, new() { 24, 351 }, new() { 25, 351 }, new() { 26, 351 }, new() { 27, 351 }, new() { 28, 351 }, new() { 29, 351 }, new() { 30, 351 }, new() { 31, 351 }, new() { 32, 404 }, new() { 33, 407 }, new() { 34, 380 }, new() { 35, 380 }, new() { 36, 380 }, new() { 37, 380 }, new() { 38, 380 }, new() { 39, 380 }, new() { 40, 380 }, new() { 41, 380 }, },
                [9] = new() { new() { 10, 380 }, new() { 11, 380 }, new() { 12, 380 }, new() { 13, 380 }, new() { 14, 380 }, new() { 15, 380 }, new() { 16, 380 }, new() { 17, 380 }, new() { 18, 380 }, new() { 19, 380 }, new() { 20, 357 }, new() { 21, 406 }, new() { 22, 351 }, new() { 23, 351 }, new() { 24, 351 }, new() { 25, 351 }, new() { 26, 351 }, new() { 27, 351 }, new() { 28, 351 }, new() { 29, 351 }, new() { 30, 351 }, new() { 31, 351 }, new() { 32, 351 }, new() { 33, 404 }, new() { 34, 405 }, new() { 35, 407 }, new() { 36, 380 }, new() { 37, 380 }, new() { 38, 380 }, new() { 39, 380 }, new() { 40, 380 }, new() { 41, 380 }, new() { 42, 380 }, new() { 43, 380 }, new() { 44, 380 }, new() { 45, 380 }, },
                ...
                [11] = new() { new() { 11, 380 }, new() { 12, 380 }, new() { 13, 380 }, new() { 14, 380 }, new() { 15, 380 }, new() { 16, 381 }, new() { 17, 351 }, new() { 18, 351 }, new() { 19, 351 }, new() { 20, 351 }, new() { 21, 351 }, new() { 22, 353 }, new() { 23, 377 }, new() { 24, 175 }, new() { 25, 175 }, new() { 26, 175 }, new() { 27, 175 }, new() { 28, 175 }, new() { 29, 375 }, new() { 30, 376 }, new() { 31, 376 }, new() { 32, 376 }, new() { 33, 403 }, new() { 34, 351 }, new() { 35, 351 }, new() { 36, 351 }, new() { 37, 351 }, new() { 38, 351 }, new() { 39, 379 }, new() { 40, 380 }, new() { 41, 380 }, new() { 42, 380 }, new() { 43, 380 }, new() { 44, 380 }, },
                ...
                [13] = new() { new() { 11, 380 }, new() { 12, 380 }, new() { 13, 357 }, new() { 14, 405 }, new() { 15, 406 }, new() { 16, 351 }, new() { 17, 351 }, new() { 18, 353 }, new() { 19, 376 }, new() { 20, 376 }, new() { 21, 377 }, new() { 22, 175 }, new() { 23, 175 }, new() { 24, 175 }, new() { 25, 175 }, new() { 26, 175 }, new() { 27, 175 }, new() { 28, 175 }, new() { 29, 175 }, new() { 30, 175 }, new() { 31, 175 }, new() { 32, 175 }, new() { 33, 375 }, new() { 34, 376 }, new() { 35, 376 }, new() { 36, 403 }, new() { 37, 351 }, new() { 38, 351 }, new() { 39, 351 }, new() { 40, 404 }, new() { 41, 405 }, new() { 42, 407 }, new() { 43, 380 }, new() { 44, 380 }, },
                [14] = new() { new() { 11, 380 }, new() { 12, 380 }, new() { 13, 381 }, new() { 14, 351 }, new() { 15, 351 }, new() { 16, 351 }, new() { 17, 351 }, new() { 18, 352 }, new() { 19, 175 }, new() { 20, 175 }, new() { 21, 175 }, new() { 22, 175 }, new() { 23, 175 }, new() { 24, 175 }, new() { 25, 200 }, new() { 26, 201 }, new() { 27, 201 }, new() { 28, 201 }, new() { 29, 201 }, new() { 30, 203 }, new() { 31, 175 }, new() { 32, 175 }, new() { 33, 175 }, new() { 34, 175 }, new() { 35, 175 }, new() { 36, 350 }, new() { 37, 351 }, new() { 38, 351 }, new() { 39, 351 }, new() { 40, 351 }, new() { 41, 351 }, new() { 42, 379 }, new() { 43, 380 }, new() { 44, 380 }, },
                [15] = new() { new() { 11, 380 }, new() { 12, 380 }, new() { 13, 381 }, new() { 14, 351 }, new() { 15, 351 }, new() { 16, 351 }, new() { 17, 353 }, new() { 18, 377 }, new() { 19, 175 }, new() { 20, 175 }, new() { 21, 175 }, new() { 22, 175 }, new() { 23, 200 }, new() { 24, 201 }, new() { 25, 202 }, new() { 26, 226 }, new() { 27, 226 }, new() { 28, 226 }, new() { 29, 226 }, new() { 30, 177 }, new() { 31, 203 }, new() { 32, 175 }, new() { 33, 175 }, new() { 34, 175 }, new() { 35, 175 }, new() { 36, 375 }, new() { 37, 376 }, new() { 38, 403 }, new() { 39, 351 }, new() { 40, 351 }, new() { 41, 351 }, new() { 42, 379 }, new() { 43, 380 }, new() { 44, 380 }, },
                ...
                [20] = new() { new() { 11, 380 }, new() { 12, 380 }, new() { 13, 381 }, new() { 14, 351 }, new() { 15, 351 }, new() { 16, 351 }, new() { 17, 352 }, new() { 18, 175 }, new() { 19, 175 }, new() { 20, 175 }, new() { 21, 175 }, new() { 22, 175 }, new() { 23, 250 }, new() { 24, 252 }, new() { 25, 226 }, new() { 26, 226 }, new() { 27, 226 }, new() { 28, 226 }, new() { 29, 226 }, new() { 30, 226 }, new() { 31, 226 }, new() { 32, 178 }, new() { 33, 253 }, new() { 34, 175 }, new() { 35, 175 }, new() { 36, 325 }, new() { 37, 326 }, new() { 38, 328 }, new() { 39, 351 }, new() { 40, 351 }, new() { 41, 351 }, new() { 42, 379 }, new() { 43, 380 }, new() { 44, 380 }, },
                ...
                [23] = new() { new() { 11, 380 }, new() { 12, 380 }, new() { 13, 380 }, new() { 14, 380 }, new() { 15, 382 }, new() { 16, 356 }, new() { 17, 351 }, new() { 18, 351 }, new() { 19, 351 }, new() { 20, 378 }, new() { 21, 327 }, new() { 22, 175 }, new() { 23, 175 }, new() { 24, 175 }, new() { 25, 175 }, new() { 26, 175 }, new() { 27, 175 }, new() { 28, 175 }, new() { 29, 175 }, new() { 30, 175 }, new() { 31, 175 }, new() { 32, 175 }, new() { 33, 175 }, new() { 34, 325 }, new() { 35, 326 }, new() { 36, 328 }, new() { 37, 351 }, new() { 38, 351 }, new() { 39, 354 }, new() { 40, 332 }, new() { 41, 380 }, new() { 42, 380 }, new() { 43, 380 }, new() { 44, 380 }, },
                ...
                [27] = new() { new() { 14, 380 }, new() { 15, 380 }, new() { 16, 380 }, new() { 17, 380 }, new() { 18, 380 }, new() { 19, 382 }, new() { 20, 356 }, new() { 21, 351 }, new() { 22, 351 }, new() { 23, 351 }, new() { 24, 351 }, new() { 25, 351 }, new() { 26, 351 }, new() { 27, 351 }, new() { 28, 351 }, new() { 29, 351 }, new() { 30, 351 }, new() { 31, 351 }, new() { 32, 351 }, new() { 33, 351 }, new() { 34, 351 }, new() { 35, 351 }, new() { 36, 379 }, new() { 37, 380 }, new() { 38, 380 }, new() { 39, 380 }, new() { 40, 380 }, },
            ...
            groundCodes = new()
            {
                [0] = new() { new() { 25, 66 }, new() { 26, 67 }, new() { 27, 68 }, new() { 28, 69 }, new() { 29, 70 }, new() { 30, 71 }, },
                [1] = new() { new() { 24, 78 }, new() { 25, 79 }, new() { 26, 80 }, new() { 27, 81 }, new() { 28, 82 }, new() { 29, 83 }, new() { 30, 84 }, new() { 31, 85 }, },
                [2] = new() { new() { 24, 65 }, new() { 25, 66 }, new() { 26, 67 }, new() { 27, 68 }, new() { 28, 69 }, new() { 29, 70 }, new() { 30, 71 }, new() { 31, 72 }, },
                [3] = new() { new() { 24, 78 }, new() { 25, 79 }, new() { 26, 80 }, new() { 27, 81 }, new() { 28, 82 }, new() { 29, 83 }, new() { 30, 84 }, new() { 31, 85 }, },
                [4] = new() { new() { 24, 65 }, new() { 25, 66 }, new() { 26, 67 }, new() { 27, 68 }, new() { 28, 69 }, new() { 29, 70 }, new() { 30, 71 }, new() { 31, 72 }, },
                [5] = new() { new() { 24, 78 }, new() { 25, 79 }, new() { 26, 80 }, new() { 27, 81 }, new() { 28, 82 }, new() { 29, 83 }, new() { 30, 84 }, new() { 31, 85 }, },
