...
namespace StardewDruid.Location
{
    ...
    public class Grove : DruidLocation
    {
        ...
        public override void updateWarps()
        {
            ...
            warpSets.Add(new WarpTile(42, 8, caveName, (int)caveEntry.X, (int)caveEntry.Y));

            warpSets.Add(new WarpTile(41, 23, farmName, (int)farmEntry.X, (int)farmEntry.Y));

            warpSets.Add(new WarpTile(42, 23, farmName, (int)farmEntry.X, (int)farmEntry.Y));

            warpSets.Add(new WarpTile(43, 23, farmName, (int)farmEntry.X, (int)farmEntry.Y));

            warps.Add(new Warp(42, 8, caveName, (int)caveEntry.X, (int)caveEntry.Y, flipFarmer: false));

            warps.Add(new Warp(41, 23, farmName, (int)farmEntry.X, (int)farmEntry.Y, flipFarmer: false));

            warps.Add(new Warp(42, 23, farmName, (int)farmEntry.X, (int)farmEntry.Y, flipFarmer: false));

            warps.Add(new Warp(43, 23, farmName, (int)farmEntry.X, (int)farmEntry.Y, flipFarmer: false));
