...
namespace StardewDruid.Location
{
    ...
    public class Grove : DruidLocation
    {
        ...
        public override void updateWarps()
        {
            ...
            warpSets.Add(new WarpTile(20, 3, LocationData.druid_gate_name, 27, 33));

            warpSets.Add(new WarpTile(21, 3, LocationData.druid_gate_name, 27, 33));

            warpSets.Add(new WarpTile(22, 3, LocationData.druid_gate_name, 27, 33));

            warpSets.Add(new WarpTile(23, 3, LocationData.druid_gate_name, 27, 33));

            warps.Add(new Warp(20, 3, LocationData.druid_gate_name, 27, 33, flipFarmer: false));

            warps.Add(new Warp(21, 3, LocationData.druid_gate_name, 27, 33, flipFarmer: false));

            warps.Add(new Warp(22, 3, LocationData.druid_gate_name, 27, 33, flipFarmer: false));
