        ...
        public static Dictionary<string, Quest> QuestList()
        {
            Dictionary<string, Quest> dictionary = new Dictionary<string, Quest>()
            {
                ...
                ["lessonTotem"] = new Quest()
                {
                    ...
                    questObjective = "Draw the power out of two different warp shrines by striking them with Rite of the Mists. Unlocks chance for double extraction.",
                    questReward = 600,
                    questProgress = 2,
                ...
                ["lessonFishspot"] = new Quest()
                {
                    ...
                    questObjective = "Strike open water to create fishing spots. Use a fishing rod to cast a line over the spot and wait for the fishing minigame to auto-trigger. Attempt ten catches. Quest completion unlocks rarer fish.",
                    questReward = 800,
                    questProgress = 2,
                ...
                ["lessonPortal"] = new Quest()
                {
                    ...
                    questObjective = "Create a portal in the backwoods, railroad or secret woods by placing down a torch (the small candle like type) and striking it with Rite of the Mists. Every torch included in the rite increases the challenge.",
                    questReward = 1000,
                    questProgress = 2,
